function uData = flowArrival(available, availableActive, flowRate, N, currentTime, mu)
    ...
    if pathlength > 0            
        ...
        if pathlength > 0
            ...
            %routeOptimization(uData,flowRate,N,mu,currentTime,availableActive);%run the route optimization when links are added to the active network
        end  
    end
